...
This vocabulary database imports data from **OpenJLPT**:
https://github.com/evanclan/OpenJLPT/blob/main/data/json/vocab/n5.json

The OpenJLPT data is used under the **Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)** license. The complete upstream license text is in `openjlpt-LICENSE.txt`.

## Upstream sources listed by OpenJLPT

The following is reproduced from OpenJLPT's `NOTICE.md`:
...
JLPT vocabulary levels are unofficial community-standard assignments, not official classifications issued by the Japan Educational Exchanges and Services or any other JLPT administrator.
